...
class PlayerScore(Base, Timestamp):
    ...
    # relacionamentos ORM
    player: Mapped["Player"] = relationship("Player", back_populates="player_scores")
    round: Mapped["Round"] = relationship("Round", back_populates="player_scores")
    season: Mapped["Seasons"] = relationship("Seasons", back_populates="player_scores")
