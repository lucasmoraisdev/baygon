...
class Match(Base, Timestamp):
    ...
    away_team_id: Mapped[int] = mapped_column(ForeignKey("teams.id_round"), nullable=False)
    ...
    away_team: Mapped["Teams"] = relationship("Teams", foreign_keys=[away_team_id])
    filmed_by_user: Mapped["User"] = relationship("User")
